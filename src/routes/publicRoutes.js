...
// Importa os middlewares a partir da pasta 'middlewares' (plural). O diretório
// singular 'middleware' foi removido para evitar confusão. Esses middlewares
// validam a assinatura e o limite mensal de agendamentos.
...
// Dados públicos do agendamento (para modal pós-checkout)
router.get('/appointments/:id', getAppointmentPublic);

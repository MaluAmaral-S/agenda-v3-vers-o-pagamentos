...
import Logo from "@/assets/logo-agendemi-mark.svg";
...
const Header = ({ activeTab, setActiveTab }) => {
  ...
  return (
    <>
      <header className="bg-gradient-to-r from-[#0B2A4A] to-[#0C3B66] shadow-lg">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center py-6">
            <div className="flex items-center space-x-4">
              <img src={Logo} alt="Agende-mi" className="w-12 h-12" />
              <div>
                <h1 className="text-2xl font-bold text-white">Agende-mi</h1>

    ...
    return (
      <div className="min-h-screen bg-gray-50 flex items-center justify-center">
        <div className="text-center">
          <Clock className="w-8 h-8 animate-spin mx-auto mb-4 text-[#0B2A4A]" />
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="mb-8">
          <div className="flex items-center gap-3 mb-4">
            <div className="p-2 bg-[#0B2A4A] rounded-lg">
                ...
                {isOpen && (
                  <div className="space-y-3 flex-grow">
                        ...
                        <div className="flex-grow space-y-2">
                          <div className="flex items-center gap-2">
                            ...
                            <Input
                              ...
                              className="w-full px-2 py-1 border border-gray-300 rounded-md text-sm focus:ring-1 focus:ring-[#0B2A4A] focus:border-[#0B2A4A]"
                            />
                          </div>
                          <div className="flex items-center gap-2">
                    ...
                    <Button
                      ...
                      className="w-full mt-4 px-4 py-2 text-sm bg-emerald-50 text-[#0B2A4A] font-semibold rounded-lg hover:bg-emerald-100 transition-colors flex items-center justify-center gap-2"
                    >
        ...
        <div className="flex justify-center">
          <Button
            ...
            disabled={saving}
            className="bg-[#0B2A4A] hover:bg-[#09304F] text-white px-6 py-3 text-lg font-medium rounded-lg transition-colors flex items-center justify-center"
          >
            {saving ? (
              <>

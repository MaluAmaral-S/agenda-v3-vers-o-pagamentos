...
const Login = () => {
  ...
  // Ajustar aba a partir da query (?tab=register|login)
  useEffect(() => {
      ...
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          <div className="inline-flex items-center justify-center w-16 h-16 bg-white rounded-full mb-4 shadow-lg">
            <CalendarCheck className="w-8 h-8 text-[#0B2A4A]" />
          </div>
          <h1 className="text-3xl font-bold text-white mb-2">Agende-mi</h1>
            ...
            <form onSubmit={handleLogin} className="space-y-6">
              <div>
                ...
                <Input
                  ...
                  className="mt-1 bg-white/20 border-white/30 text-white placeholder-white/90 focus:border-white focus:ring-white"
              ...
              <div>
                ...
                <div className="relative mt-1">
                  <Input
                    ...
                    className="bg-white/20 border-white/30 text-white placeholder-white/90 focus:border-white focus:ring-white pr-10"
              ...
              <div className="flex items-center justify-between">
                <label className="flex items-center">
                  <input
                    type="checkbox"
                  className="rounded border-white/30 text-[#0B2A4A] focus:ring-white"
                  />
              ...
              <Button
                type="submit"
                disabled={isLoading}
                className="w-full bg-white text-[#0B2A4A] hover:bg-gray-100 font-semibold py-3 btn-hover"
              >
                {isLoading ? (
                  <>
